...
|------|--------------|-----|
| `01_schema.sql` | `catalog_item` + `onboarding_template` + content_hash doorbell | before request |
...
| `load_data.py` | `catalog_item.json` + `onboarding_template.json` → itsm | after 01 |

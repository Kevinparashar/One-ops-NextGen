# BUILD_STATUS.md — POC-5-MW Production Rebuild

Tracks the 11-phase build (MIGRATION.md P1–P11). Source of truth — conversation
...
`tools/migrate_registry_v2.py` — 2 agents (`uc01_summarization`,
...
| `tools/gen_proto.sh`, `make proto`, `make proto-check` | regeneration + CI staleness gate. |
...
**Exit criteria (MIGRATION.md P10):**
...
| `RUNBOOK.md` | On-call procedures — find a trace, roll back an agent version, hot-change policy, rotate keys, drain a subject, failure signatures. |
...
**Exit criteria (MIGRATION.md P11):**
...
**Remaining before production** (named, tracked — see `RUNBOOK.md §9`):

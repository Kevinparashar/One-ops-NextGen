...
related: docs/planning/production-maturity-plan.md, registries/, src/oneops/
---
...
> — `docs/planning/production-maturity-plan.md` §F-LOCKED
...
- `docs/planning/production-maturity-plan.md` §A, §C, §F-LOCKED, §G — source of truth for axes + locked plan + open questions

...
| `01_stack_components.md` | LangGraph, NATS, OTEL, codec, LLM gateway — deeper detail |
| `02_uc_pack_structure.md` | What a UC folder contains. No common file bloat. |
...
| `07_starting_steps.md` | Concrete order — from empty folder to working UC-1 |

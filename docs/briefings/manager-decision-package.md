...
related: docs/planning/production-maturity-plan.md (§G), docs/planning/pmg-coverage-gap-analysis.md
---
...
- Update `docs/planning/production-maturity-plan.md` §F-LOCKED with the new sequence

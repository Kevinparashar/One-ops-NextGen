# docs/history/CLEANUP.md — POC-5-MW Phase 1 Inventory & Prune
...
| `data/`, `registries/`, `contracts/`, `ops/`, migrations, `.env`, `docs/policies/updated_policy_v2.md` | Durable assets — explicitly preserved per the brief's "Keep" list. |

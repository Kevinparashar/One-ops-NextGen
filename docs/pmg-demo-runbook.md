...
**Companion docs.** Hand out [`docs/manager-decision-package.md`](manager-decision-package.md)
...
Open `docs/production-maturity-plan.md` §F-LOCKED. State plainly:
...
Hand out `docs/manager-decision-package.md`. Page through the 10

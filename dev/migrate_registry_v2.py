...
P1 migration (docs/history/MIGRATION.md). Reads nothing destructively — the legacy
...
Run:  .venv/bin/python dev/migrate_registry_v2.py [--force]
...
def _tool_records() -> list[ToolRecord]:
    common = {"owner": "team-itsm", "version": 1}
    return [
        ToolRecord(
            ...
            timeout_ms=15_000, idempotent=True, requires_scopes=(_READ_TICKET,), **common),
        ToolRecord(
        ...
        ToolRecord(
            ...
            execution_type=ExecutionTier.READ, parameters=_TICKET_PARAMS,
            timeout_ms=60_000, idempotent=True, requires_scopes=(_READ_TICKET,), **common),
        ToolRecord(
            ...
            timeout_ms=5_000, idempotent=True, requires_scopes=(_READ_TICKET,), **common),
        ToolRecord(
        ...
        ToolRecord(
            ...
            timeout_ms=20_000, idempotent=True, requires_scopes=(_READ_KB,), **common),
        ToolRecord(
        ...
        ToolRecord(
            ...
            parameters=(ToolParameter(name="article_id", type="str", required=True,
                        ...
                        ToolParameter(name="tenant_id", type="str", required=True,
                        description="Tenant scope from the request envelope.")),
            timeout_ms=15_000, idempotent=True, requires_scopes=(_READ_KB,), **common),
    ]
